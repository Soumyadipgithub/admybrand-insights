    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 relative">
      <div className="max-w-7xl mx-auto px-6 py-8 relative z-10">
            ...
            {isLoading ? (
              ...
              <>
                ...
                <Button
                  ...
                  disabled={isLoading}
                  className="bg-slate-800 border-slate-600 hover:bg-slate-700 hover:border-teal-500 transition-all duration-200 rounded-lg text-gray-300"
                >
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3 mb-8">
          ...
          {/* User Demographics */}
          <div>
            <Card className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 shadow-lg hover:shadow-xl transition-all duration-300 h-full">
              <CardHeader className="pb-4">
                <CardTitle className="text-xl font-bold text-white">User Demographics</CardTitle>
                <p className="text-gray-300">Age distribution of users</p>
              </CardHeader>
              <CardContent>
                <div className="h-80">
                  <DonutChart
        ...
        <div className="grid gap-8 md:grid-cols-2 mb-8">
          ...
          <Card className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 shadow-lg hover:shadow-xl transition-all duration-300">
            <CardHeader className="pb-4">
              <CardTitle className="text-xl font-bold text-white">Revenue by Channel</CardTitle>
              <p className="text-gray-300">Revenue distribution by marketing channel</p>
            </CardHeader>
            <CardContent>
              <div className="h-80">
                <BarChart
          ...
          <Card className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 shadow-lg hover:shadow-xl transition-all duration-300">
            <CardHeader className="pb-4">
              ...
              <p className="text-gray-300">Top performing campaigns</p>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                {[
                  { name: "Social Media Campaign", value: "$2.4M", growth: "+15%", color: "bg-gradient-to-r from-teal-400 to-blue-500" },
                  ...
                  <div key={index} className="group flex items-center justify-between p-4 bg-slate-700/30 rounded-lg hover:bg-slate-700/50 transition-all duration-200 border border-slate-600/30">
                    <div className="flex items-center">
                      <div className={`w-3 h-3 rounded-full ${item.color} mr-4`}></div>
                      <div>
                        <div className="font-semibold text-white group-hover:text-gray-100 transition-colors">{item.name}</div>
        ...
        <Card className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 shadow-lg hover:shadow-xl transition-all duration-300">
          <CardHeader className="pb-4">
            <CardTitle className="text-xl font-bold text-white">Campaign Data</CardTitle>
            <p className="text-gray-300">Detailed campaign performance with sorting and filtering</p>
          </CardHeader>
          <CardContent>
