  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-slate-900 to-cyan-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-20 left-20 w-3 h-3 bg-cyan-400 rounded-full animate-ping shadow-lg shadow-cyan-400/50" />
        <div className="absolute top-40 right-40 w-2 h-2 bg-purple-400 rounded-full animate-pulse shadow-lg shadow-purple-400/50" />
        <div className="absolute bottom-20 left-1/3 w-2.5 h-2.5 bg-pink-400 rounded-full animate-bounce shadow-lg shadow-pink-400/50" />
        <div className="absolute top-1/2 right-1/4 w-1.5 h-1.5 bg-green-400 rounded-full animate-ping shadow-lg shadow-green-400/50" />
        <div className="absolute top-1/3 left-1/4 w-1 h-1 bg-orange-400 rounded-full animate-pulse shadow-lg shadow-orange-400/50" />
      </div>
